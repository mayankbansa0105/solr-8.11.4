...
ARG SOLR_KEYS="86EDB9C33B8517228E88A8F93E48C0C6EF362B9E 50E3EE1C91C7E0CB4DFB007B369424FC98F3F6EC"
...
RUN set -ex; \
  apt-get update; \
  apt-get -y install acl dirmngr gpg lsof procps wget netcat-openbsd gosu tini; \
